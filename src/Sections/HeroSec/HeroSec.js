			...
			<div className="bg-gray-50">
				<div className="container px-6 md:px:8 lg:px-8 py-24 mx-auto">
					<div className="flex flex-col lg:flex-row justify-between items-center lg:gap-28 gap-5">
						<div>
							<div className="py-5">
								<h2 className="lg:text-4xl md:text-3xl text-xl">Hello, My name is </h2>
								...
								<div className="mt-10">
									<a
										href="https://doc-04-7o-docs.googleusercontent.com/docs/securesc/ckmt88manl8sjkdrnstgvn3qgd20i2nr/220fti86tmjplm9sbi1b77nc1en5d2m5/1638188025000/13842738650638944735/13842738650638944735/1HOZtD3yDqL22DAEGAhf5XHpJgz5BDiUP?e=download&authuser=1&nonce=psa1dcdnm8as2&user=13842738650638944735&hash=tna4tfup90a5jdjo7n5l0dbn4nt2p8bn"
